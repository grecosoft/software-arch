...
using Examples.MicroserviceOne.App.Plugin;
using Examples.MicroserviceOne.Domain.Plugin;
using Examples.MicroserviceOne.Infra.Plugin;
using Examples.MicroserviceOne.WebApi.Plugin;
using System.Diagnostics;
using Examples.MicroserviceOne.App.Adapters;
using Examples.MicroserviceOne.Infra.Adapters;
...
builder.Services.AddHttpClient<IRecallAdapter, RecallAdapter>(c =>
{
    c.BaseAddress = new Uri("https://api.nhtsa.gov");
});
